...
- FFmpeg-renderer completion in this milestone means local MP4 composition plus foundational timed caption overlays only. It does not mean word-level subtitles, animated captions, transitions, background music, GPU encoding, cloud rendering, publishing, or production-grade editing effects are complete
